...
% Alternative Model Structure
WLS.VAL.M2.Residuals.Cx = WLS.VAL.Y.YCx_datasets - WLS.VAL.M2.Model.Cx;
WLS.VAL.M2.Residuals.Cy = WLS.VAL.Y.YCy_datasets - WLS.VAL.M2.Model.Cy;
WLS.VAL.M2.Residuals.Cz = WLS.VAL.Y.YCz_datasets - WLS.VAL.M2.Model.Cz;
WLS.VAL.M2.Residuals.Cl = WLS.VAL.Y.YCl_datasets - WLS.VAL.M2.Model.Cl;
WLS.VAL.M2.Residuals.Cm = WLS.VAL.Y.YCm_datasets - WLS.VAL.M2.Model.Cm;
WLS.VAL.M2.Residuals.Cn = WLS.VAL.Y.YCn_datasets - WLS.VAL.M2.Model.Cn;
